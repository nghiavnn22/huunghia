 ...
 */
public class DaTa2 {
    private static final String url = "//192.168.1.4/data";
    public static void main(String[] args) {
        try {
            ServerDataImpl serverDataImpl = new ServerDataImpl();
            System.out.println("Kich hoat server data 2.....");
            ...
            System.out.println("---------------------------"
                    + "\n[Loi] "+DaTa2.class.getName()+", create serverDataImpl."+
                    "\n---------------------------");
            Logger.getLogger(DaTa2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (AlreadyBoundException ex) {
            System.out.println("---------------------------"
                    + "\n[Loi] "+DaTa2.class.getName()+", create registry."+
                    "\n---------------------------");
            Logger.getLogger(DaTa2.class.getName()).log(Level.SEVERE, null, ex);
